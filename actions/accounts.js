...
export async function updateDefaultAccount(accountId){
    ...
    return {success:true, data:serializeTransaction(account)};
      ...
      return {success:false, error: error.message || "An error occurred while updating the default account"};
    }
}
...
return {success: false, error: error.message || "An error occurred while deleting transactions" };
  }
}