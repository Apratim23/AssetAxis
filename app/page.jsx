  ...
  return(
    <div className="mt-40">
      ...
      <section className="py-20">
       <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12">All about managing your finances</h2>
      ...
      <section className="py-20 bg-blue-600">
             <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-blue-100 mb-8 max-w-2xl mx-auto">Be amongst the many who are already managing their finances with AssetAxis</p>
              <Link href="/dashboard">
              <Button
                size="lg" className="bg-white text-blue-600 hover:bg-blue-100 animate-bounce">
                  Start Your Trial
                </Button></Link>
       </div>
      </section>
